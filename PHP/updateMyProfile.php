...
$query= "SELECT * from createmyprofile where Id =$ID";
...
while($row = $result->fetch_assoc()){
    ...
    $institute = $rowT['institute'];
    $ins_since = $row['ins_since'];
    $ins_till = $row['ins_till'];
    $skiil = $row['skiil'];
        ...
        <section class="myPofile" id="Form" >
            ...
            <form class="signup-form" method="post">           
                ...
                <div class="form-body">
                    ...
                    <div class="horizontal-group">
                        <div class="form-group left">
                            ...
                            <input type="date" name="ins_since" class="form-input"  value = "<?php echo $row ['ins_scince'];?>" >
                        </div>
                        <div class="form-group right">
                ...
                <div class="form-footer">
                    ...
                    <button type="done" class="btn" name ="done"> <a href="myProfile.php?GETID=<?php echo $ID?>" >Done</a></button>
