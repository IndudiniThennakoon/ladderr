...
if(isset($_POST['submit'])){  
    ...
    $sql = "INSERT INTO 'createmyprofile'(firstname,lastname,username,
    add1,add2,province,city,email,mobile,bio,qualification,institute,ins_since,
    ins_since,skiil,language,experience,position,since,till)
    VALUES($firstname,$lastname,
    $username,$add1,$add2,$province,$city,$email,$mobile,$bio,$qualification,$institute,
    $ins_since,$ins_since,$skiil,$language,$experience,$position,$since,$till)";
		...
		<form class="signup-form" method="post">
			...
			<div class="form-body">
				...
				<div class="form-group">
					...
					<input type="mobile" name="mobile" class="form-input" placeholder="+94|">
				</div>
				...
				<div class="form-group">
					...
					<input type="institute" name="institute" class="form-input" placeholder="enter your email">
				</div>
				...
				<div class="form-group">
					...
					<input type="lang" name="language"  class="form-input" placeholder="">
				</div>
				...
				<div class="form-group">
					...
					<label for="com name" class="label-title">Company Name</label>
					<input type="com name" name="com name" class="form-input" placeholder="" >
				</div>	
			...
			<div class="form-footer">
				...
				<button type="reset" class="btn" name ="reset">Create</button>
			  </div>
